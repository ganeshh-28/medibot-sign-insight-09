    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container mx-auto py-6 px-4">
        <div className="mb-6 flex justify-between items-center">
          <div>
            <h1 className="text-2xl font-bold text-medical-primary">Doctor Consultation View</h1>
            <p className="text-gray-600">Connected with: Patient #12345</p>
          </div>
          
          <div className="flex gap-3">
            <Button variant="outline" asChild>
              <Link to="/video-consultation/patient">Switch to Patient View</Link>
            </Button>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 h-[calc(100vh-220px)]">
          ...
          <div className="h-full flex flex-col">
            <div className="flex-1 mb-4">
              <ConsultationChat userRole="doctor" />
            </div>
            <ConsultationInput userRole="doctor" />
          </div>
        </div>
      </main>
    </div>
